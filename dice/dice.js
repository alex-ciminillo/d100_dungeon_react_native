...
(function(dice) {
    ...
    this.desk_color = 'rgba(255, 255, 255)';
    ...
    this.dice_box = function(container, dimentions) {
        ...
        barrier.position.set(0, this.h * .6, 0);
    ...
    this.dice_box.prototype.reinit = function(container, dimentions) {
        ...
        this.ch = container.clientHeight / 1.82;
        // if (dimentions) {
        //     this.w = dimentions.w;
        //     this.h = dimentions.h;
        // }
        ...
        this.desk = new THREE.Mesh(new THREE.PlaneGeometry(this.w * 2, this.h * 1.4, 1, 1), 
                new THREE.MeshPhongMaterial({ color: that.desk_color, opacity: 0.1,
                    transparent: true }));
